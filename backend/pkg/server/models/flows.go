...
type Flow struct {
	...
	MemoryVectorEnabled *bool            `form:"memory_vector_enabled,omitempty" json:"memory_vector_enabled,omitempty" validate:"omitempty" gorm:"-"`
	MemoryVectorReason  *string          `form:"memory_vector_reason,omitempty" json:"memory_vector_reason,omitempty" validate:"omitempty" gorm:"-"`
}
