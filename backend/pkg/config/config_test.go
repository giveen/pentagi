...
func clearConfigEnv(t *testing.T) {
	...
	envVars := []string{
		...
		"DOCKER_INSIDE", "DOCKER_NET_ADMIN", "DOCKER_SECCOMP_UNCONFINED", "DOCKER_APPARMOR_UNCONFINED", "DOCKER_SOCKET", "DOCKER_NETWORK",
		...
		"LLM_SERVER_CONFIG_PATH", "LLM_SERVER_MAX_PARALLEL", "LLM_SERVER_MODEL_SWITCH_DELAY_MS",
		"LLM_SERVER_TEST_PARALLEL_WORKERS", "LLM_SERVER_LEGACY_REASONING", "LLM_SERVER_PRESERVE_REASONING",
