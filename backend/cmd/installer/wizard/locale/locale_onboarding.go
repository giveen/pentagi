...
// Onboarding locale constants.
// Includes welcome flow, system checks, troubleshooting, EULA, and main menu copy.
...
// Section: Welcome Troubleshooting
const (
...
// Section: Main Menu Status Labels (Not Used)
const (
